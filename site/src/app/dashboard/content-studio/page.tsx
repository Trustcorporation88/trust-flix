            ...
            <div className="mt-4">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {accounts?.data?.integrations?.length ? (
                  ...
                  <div className="w-full rounded-lg border border-dashed border-white/15 bg-white/[0.03] p-4">
                    <p className="text-sm font-semibold text-white">Conecte uma conta para publicar</p>
                    <p className="mt-1 text-xs leading-5 text-ink-400">
                      Abra o Postiz, adicione seu canal e volte para atualizar a lista.
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <a
                        ...
                        className="inline-flex items-center gap-2 rounded-md bg-signal-500 px-3 py-2 text-xs font-semibold text-white hover:bg-signal-600"
                      >
                      ...
                      <button
                        ...
                        className="rounded-md border border-white/15 px-3 py-2 text-xs font-semibold text-ink-200 hover:bg-white/[0.05]"
                      >
                        Atualizar contas
                      </button>
                    </div>
